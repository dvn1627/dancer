            ...
            <div class="modal-body">
                <form id="add_form">
                    ...
                    <div class="form-group">
                        <label>
                            Название
                            <input required type="text" id="n_name" name="name" placeholder="название..." class="form-control input-sm">
                        </label>
                    </div>
                     <div class="form-group">
                        <label>
                    ...
                    <div class="form-group" id="city_block">
                        <label>
                            Город
                            <select required class="form-control" id="n_city" name="city_id">
                        ...
                        <label>
                            Организатор
                            <select required class="form-control" id="n_org" name="org_id">
                    ...
                    <div class="form-group">
                        <label>
                            Направление
                            <select  required class="form-control" id="n_way" name="way_id">
                                <?php echo $ways; ?>
                            </select>
                        </label>
                    </div>
                    <div class="form-group">
                        <label>
                            Дата начала регистрации
                            <input required type="date" id="n_date_reg_open" name="date_reg_open" placeholder="начало регистрации..." class="form-control input-sm">
                        </label>
                    </div>
                    <div class="form-group">
                        <label>
                            Дата окончания регистрации
                            <input required type="date" id="n_date_reg_close" name="date_reg_close" placeholder="окончание регистрации..." class="form-control input-sm">
                        </label>
                    </div>
                    <div class="form-group">
                        <label>
                            Дата начала конкурса
                            <input required type="date" id="n_date_open" name="date_open" placeholder="начало конкурса..." class="form-control input-sm">
                        </label>
                    </div>
                    <div class="form-group">
                        <label>
                            Дата окончания конкурса
                            <input required type="date" id="n_date_close" name="date_close" placeholder="окончание конкурса..." class="form-control input-sm">
                        </label>
                    </div>
                </div>
                </div>
