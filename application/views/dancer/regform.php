        ...
        <div class="row">
                ...
                <div class="col-md-4">
                        <div class="form-group">
                            <label>
                                Дата рождения
                                <input required  type="date" id="birth" name="birth" class="form-control">
                            </label>
                        </div>
                        <div class="form-group">
                            <label>Организация</label>
                            <select  required name="belly" id="belly" class="form-control">
                        ...
                        <div class="form-group" id="trainers">
                                <label>Тренер</label>
                                <select  required name="trainer" class="form-control" id="trainer">
